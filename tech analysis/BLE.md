После долгого ресерча было выявлено следующее: wifi-direct не поддерживается на разных платформах. Потому не будет возможности подключать несколько устройств в одну суть
